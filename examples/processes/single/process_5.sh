...
do
    ...
    python ./examples/basic_usage/sim_lidar.py --trace-path ./examples/vista_traces/lidar_5 --frame ${i} --resolution 0.1 --yaw-min 180 --yaw-max 180 --pitch-min -60 --pitch-max 30
